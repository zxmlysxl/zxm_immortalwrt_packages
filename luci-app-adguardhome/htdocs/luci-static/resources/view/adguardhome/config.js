...
return view.extend({
	...
	render: function (data) {
		...
		var m = new form.Map('adguardhome', _('AdGuardHome Configuration'),
			_('A graphical DNS monitoring and filtering plugin with default username and password admin' )
		);
		...
		o = s.option(form.Value, 'port', _('Browser management port'));
		o.default = '3000';
		...
		o = s.option(form.Value, 'web_username', _('Username for AdGuardHome'), _('Login username when setting up AdGuardHome'));
		o.default = 'admin';

		o = s.option(form.Value, 'web_password', _('Password for AdGuardHome'), _('Set AdGuardHome login password'));
		o.password = true;
		o.default = 'admin';
